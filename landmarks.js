...
const LANDMARKS = [
  ...
  },
  {
    ...
    px: 2590, py: 1755,
    address: 'Bishop Hill',
    blurb: 'The Baptist church with the white steeple at the heart of Bishop Hill. David Rourke pastored this congregation for twenty-four years, the last of them performing a faith that had quietly gone. In <em>The Silent Pastor</em> he leaves the pulpit, the parsonage, the town, and the marriage, and a year later returns to pastor the doubt itself.',
  ...
  // ── Waterfront (lake labels are at top of map already) ──
  {
    ...
    blurb: 'The town&rsquo;s drinking water, its public beach, its northern boundary, the lake the children swam in every summer for fifty years. The cadmium stayed concentrated in the nearshore shallows, worst in June (<em>The Honest Woman</em>). Nora Finch nearly drowned here at twenty-two and runs the marina on its shore (<em>The Saved Woman</em>). Route 11 dives under it through the lake tunnel toward Bridgeport (<em>The Distant Man</em>, <em>The Lawyer Daughter</em>). The Marsh family&rsquo;s &ldquo;best and cleanest hour&rdquo; was a beach day here, unknowably, already poisoned.',
  ...
  },
  {
    ...
    blurb: 'The town&rsquo;s commercial heart. The Lamplighter, Roasters, Haskell Hardware, the Sentinel, First Federal, the barbershop, the florist, the dry cleaner, the Varsity Theater, the row that has been the row since the Eisenhower administration, now half-vacant as the big-box bypass draws the trade south. The florist (<em>The Distant Husband</em>) and the barbershop (<em>The Ambitious Son</em>) each hold a Seer scene; nearly every book passes through this street. Downtown is where the town meets itself.',
...

  {
    ...
    blurb: 'The basement cafeteria coffee station at St. Clare’s. In <em>The Steady Hand</em>, the Seer stands at the sugar caddy with his hands placed flat and waiting, and names the date, the patient, and the 1.3-second tremor at the fourth ventricle, then leaves a sealed surgical glove, Neil Mercer’s size, dated the day of the surgery.',
    books: ['the-steady-hand'],
    seerScene: true,
  },
  {
    // The Reluctant Witness, Rachel Kim, River Street parking lot in Caldwell (off-map).
    id: 'ferry-street-lot',
    name: 'River Street Lot (Caldwell)',
    category: 'seer',
    px: 2480, py: 1640,   // placeholder; The Reluctant Witness is set in Caldwell, not Harmon, retune via ?debug
    address: 'The parking lot behind Ferreira&rsquo;s, River Street, Caldwell',
    blurb: 'The restaurant-district parking lot in Caldwell where Rachel Kim, walking to her car alone on date night, sees one man shoot another and the streetlight catches the killer&rsquo;s scarred face. In <em>The Reluctant Witness</em> the warning comes later, on the courthouse bench: testify and the truth is hers, but the cost, the new names, the relocation, the marriage that follows but does not forgive, is the family&rsquo;s.',
  ...
  },
  {
    ...
    blurb: 'The old third-floor chapel at St. Clare’s, deconsecrated in 1991 but still called the chapel. In <em>The Merciful Nurse</em>, a stranger sits with Luisa Dominguez here and names the milligram increment that is the difference between comfort and the act the criminal code has a name for, and the audit that will flag it.',
    books: ['the-merciful-nurse'],
    seerScene: true,
  },
  {
    // The Silent Pastor, the pulpit / second anchor for First Baptist.
    id: 'first-baptist-pulpit',
    name: 'First Baptist Pulpit',
    category: 'seer',
    px: 2524, py: 1700,   // the pulpit, First Baptist Church
    address: 'The pulpit, First Baptist Church, Harmon',
    blurb: 'The pulpit David Rourke preached from for twenty-four years, the last of them performing a faith that had quietly gone. In <em>The Silent Pastor</em>, a stranger in the Harmon Clinic waiting room names the cost of telling the truth, the pulpit, the house, the town, the marriage. He leaves all of it, and then, a year later, returns to pastor the doubt itself.',
    books: ['the-silent-pastor'],
    seerScene: true,
  },
  {
  ...
  },
  {
    ...
    blurb: 'The poorer older street between the highway exit and downtown, laundromat, Rite Aid, apartments above storefronts; the &ldquo;other Harmon.&rdquo; Elena Voss downsizes to the apartment above the dry cleaner here in <em>The Tending Woman</em>; one of Kevin Reilly’s laundromats is on this block (<em>The Loyal Man</em>); and the caregiver world of <em>The Distant Husband</em> runs through its support-group basement.',
    books: ['the-tending-woman', 'the-loyal-man', 'the-distant-husband'],
    seerScene: false,
  },
  {
    // The Loyal Daughter, Caldwell Construction yard (west side); the office sits behind Haskell.
    id: 'caldwell-construction',
    name: 'Caldwell Construction',
    category: 'industrial',
    px: 802, py: 1158,
    address: 'The Caldwell Construction yard, west side; the office sits behind Haskell Hardware downtown',
    blurb: 'Caldwell Construction, the firm that poured half the foundations in the county. The equipment yard sits on the west side; the cinderblock office Earl Caldwell built in 1983 is downtown, directly behind Haskell Hardware. In <em>The Loyal Daughter</em>, Maggie Caldwell runs it two bad winters from going under, and signs the Whitfield contract that becomes the trap, because letting her father’s firm die is a thing she would have to do.',
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    blurb: 'Where Ruth Calloway lives alone with Chester the golden retriever, the fireproof safe in the bedroom closet, the padlocked side gate. The house she paid off in 2018, and nearly the last thing the town leaves her after she files the truth. (<em>The Honest Woman</em>)',
    books: ['the-honest-woman'],
    seerScene: false,
  },
  {
    ...
    blurb: 'The Haskell house on Mill Creek Road, a modest older road of small houses where the flat country starts. Jean&rsquo;s perennial bed in the side yard finally came in the year she asks Boyd, for the last time, when he&rsquo;ll let the store go. (<em>The Quiet Man</em>)',
    books: ['the-quiet-man'],
    seerScene: false,
  },
  {
  ...
  },
  {
    ...
    blurb: 'The two-story colonial Cat and her late husband Ray bought in 2012, ~12 minutes from St. Clare&rsquo;s, where their son Miles lives, and the house Cat keeps triaging as &ldquo;stable&rdquo; while the patient she keeps missing is inside it. (<em>The Tired Mother</em>)',
    books: ['the-tired-mother'],
    seerScene: false,
  },
  {
    ...
    blurb: 'Diana Torres&rsquo;s own home, the corporate attorney who left the North End and succeeded, the executor and the planner, the one who holds the family together. The family home she returns to is her father&rsquo;s brick house on Riverside Avenue. (<em>The Lawyer Daughter</em>)',
    books: ['the-lawyer-daughter'],
    seerScene: false,
  },
  {
    ...
    blurb: 'Elena Voss&rsquo;s 1,460-square-foot Craftsman bungalow, thirty years, the same garden of dahlias, the same gray tabby in the window. The house she sells out from under herself one perennial bed at a time to keep wiring her son the money. (<em>The Tending Woman</em>)',
    books: ['the-tending-woman'],
    seerScene: false,
  },
  {
    ...
    category: 'home',
    px: 258, py: 1478,   // out a county road, by the sign to Route 9 / Marl
    address: 'A rural property out a county road, by the Route 9 sign to Marl',
    blurb: 'Maggie Caldwell&rsquo;s rural property out a county road, her father Earl keeps a cottage and workshop on the land. The firm is two bad winters from going under, and the place is the proof a daughter could carry what a father made. (<em>The Loyal Daughter</em>)',
    books: ['the-loyal-daughter'],
    seerScene: false,
  },
  {
    ...
    blurb: 'Nora Finch&rsquo;s place on the lake she has lived beside her whole life, the water that nearly took her at twenty-two and that she now tends from the marina dock. She lives alone with a cat named Anchor. (<em>The Saved Woman</em>)',
    books: ['the-saved-woman'],
    seerScene: false,
  },
  {
    ...
    category: 'home',
    px: 1380, py: 760,
    address: 'Maple Street, North End',
    blurb: 'Jack Callahan&rsquo;s mother&rsquo;s house in the North End, the home he returns to after twenty-five years of exile, for the funeral of a woman the town loved as much as it convicted her son. (<em>The Accused Man</em>)',
    books: ['the-accused-man'],
    seerScene: false,
  },
  {
    ...
    blurb: 'Neil and Claire Mercer&rsquo;s house, two physicians, two teenage sons, a standing Saturday that stops being standing. Where Claire keeps the quiet timeline of her husband&rsquo;s tremor: the wine glass, the fork, the two hands on the coffee. (<em>The Steady Hand</em>)',
    books: ['the-steady-hand'],
    seerScene: false,
  },
  {
    ...
    category: 'home',
    px: 1180, py: 980,
    address: 'Near the North End, the neighborhood he came up in',
    blurb: 'Marcus Cole&rsquo;s house, near the old North End neighborhood his mother Yvette cleaned other people&rsquo;s houses to get him out of. In <em>The Ambitious Son</em> he sits in the driveway, the threshold minute, and approves the leak from his idling car, winning the seat and losing the self his mother was proud of. (<em>The Ambitious Son</em>)',
    books: ['the-ambitious-son'],
    seerScene: false,
  },
  {
    ...
    px: 3560, py: 1380,
    address: 'East Side, Harmon',
    blurb: 'Anne Loring&rsquo;s home, the quiet foundation under a loud professional life, her husband the steady one, her daughter finishing architecture school and wanting into the firm whose ampersand is about to come off the door. (<em>The Design Partner</em>)',
    books: ['the-design-partner'],
    seerScene: false,
  },
  {
    ...
    category: 'home',
    px: 1512, py: 1006,
    address: 'Birch Lane, North End',
    blurb: 'The Morrow family house on Birch Lane, where Frank&rsquo;s ex-wife Patricia stayed and Tom, the man who stayed, raised the two children Frank left. In <em>The Distant Man</em>, Frank drives nine hours back after fifteen years away, for his mother&rsquo;s stroke and the apology he has mouthed at a windshield the whole time. (<em>The Distant Man</em>)',
    books: ['the-distant-man'],
    seerScene: false,
  },
  {
    ...
    blurb: 'David Rourke&rsquo;s parsonage beside the church, the house that comes with the pulpit. He leaves it when he leaves the faith, and a year later his wife Linda meets him in the gravel driveway and the hug lasts forty-three seconds. (<em>The Silent Pastor</em>)',
    books: ['the-silent-pastor'],
    seerScene: false,
  },
  {
  ...
  },
  {
    ...
    blurb: 'Warren Gibbs&rsquo;s house, a short walk from the English classroom he has taught in for thirty years, the one student a decade who makes it worth it, and the decision about a student that he tells himself is mercy. (<em>The Watchful Teacher</em>)',
  ...
  },
  {
    ...
    px: 3000, py: 1180,
    address: 'East Side, Harmon',
    blurb: 'Luisa Dominguez&rsquo;s house, the place she goes home to from the ICU where the word a dying man is reduced to is <em>please</em>, and where she carries the night being a good nurse and following the orders stopped being the same thing. (<em>The Merciful Nurse</em>)',
    books: ['the-merciful-nurse'],
    seerScene: false,
  },
  {
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    blurb: 'A gas station off the Route 9 turnoff on the West Edge. In <em>The Loyal Daughter</em>, the Seer is at the next island, and without turning reads the Whitfield contract Maggie Caldwell has not yet signed, the fraud in the wires, the federal charge, the four-hour drive south to Fenmore.',
    books: ['the-loyal-daughter'],
    seerScene: true,
  },
  {
    ...
    category: 'seer',
    px: 1672, py: 1138,
    address: 'The Saturday market, Oak Street, downtown',
    blurb: 'The weekly street market on Oak Street downtown, the stalls, Carol&rsquo;s jam table, the folk guitarist on the corner. In <em>The Tending Woman</em>, the Seer stands beside Elena Voss in the early light and names the spring she loses the house to keep saying yes, and the apartment above the Crane Street dry cleaner where she ends up. She leaves a seed packet, four bulbs.',
    books: ['the-tending-woman'],
    seerScene: true,
  },
  {
    ...
    category: 'seer',
    px: 1134, py: 818,
    address: 'The Torres house, Riverside Avenue, North End, after the funeral',
    blurb: 'The reception after Ernesto Torres&rsquo;s funeral, among the casseroles and the parish faces. In <em>The Lawyer Daughter</em>, a silver-haired stranger tells Diana, &ldquo;You&rsquo;ll find the drawer,&rdquo; and names the grocery list only Diana has read, before Diana has opened the locked drawer that holds forty years of checks to a second family.',
    books: ['the-lawyer-daughter'],
    seerScene: true,
  },
  {
    ...
    category: 'seer',
    px: 2010, py: 1720,   // front of the courthouse, Courthouse Square
  ...
  },
  {
    ...
    blurb: 'The corridor outside the St. Clare&rsquo;s ICU where Frank Morrow&rsquo;s mother is dying. In <em>The Distant Man</em>, the Seer names the first week of December, the discharge to Pine Ridge, and the conversation with the brother who stayed that Frank still will not have had.',
    books: ['the-distant-man'],
    seerScene: true,
  },
  {
  ...
  },
  {
    ...
    blurb: 'The Main Street barbershop, where men hear the news before their wives do. In <em>The Ambitious Son</em>, the Seer is the woman in the waiting chair who names the reporter, the date, the exact careful sentence Marcus Cole will say, and the version of himself his mother was proud of that saying it will cost.',
    books: ['the-ambitious-son'],
    seerScene: true,
  },
  {
  ...
  },
  {
    ...
    blurb: 'The St. Clare&rsquo;s ICU where Luisa Dominguez holds the line. In <em>The Merciful Nurse</em>, the warning names the morphine increment that is the difference between comfort and the act the criminal code has a name for, and the pharmacy audit that turns a mercy into a homicide. (See also the chapel pin, where the stranger sits with her.)',
    books: ['the-merciful-nurse'],
    seerScene: true,
  },
];
