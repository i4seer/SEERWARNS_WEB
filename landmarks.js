...
const LANDMARKS = [
  ...
  },
  {
    ...
    blurb: 'A downtown parking lot off Ferry Street. In <em>The Reluctant Witness</em>, a stranger finds Rachel Kim here and names the trial, the testimony, the day she gives it, and the way the town files her afterward, the cost the truth itself never warned her about.',
  ...
  },
  {
    ...
    blurb: 'The pulpit David Rourke has preached from for sixteen years, three of them without the faith he is still performing. In <em>The Silent Pastor</em>, the warning names the Sunday it stops being possible to keep preaching the thing he no longer believes. He climbs into the pulpit anyway.',
    books: ['the-silent-pastor'],
    seerScene: true,
  },
  {
  ...
  },
  {
    ...
    blurb: 'Marcus Cole&rsquo;s house, near the old neighborhood his mother cleaned other people&rsquo;s houses to get him out of, and the pothole at its edge he measures every Saturday, the one injustice he can hold in inches. (<em>The Ambitious Son</em>)',
    books: ['the-ambitious-son'],
    seerScene: false,
  },
  {
  ...
  },
  {
    ...
    px: 1620, py: 800,
    address: 'The North End',
    blurb: 'The Morrow family house, where Frank&rsquo;s mother lived and the brother who stayed still does. Frank returns through the lake tunnel after fifteen years, for the death the warning timed to the first week of December. (<em>The Distant Man</em>)',
    books: ['the-distant-man'],
    seerScene: false,
  },
  {
    ...
    blurb: 'David Rourke&rsquo;s parsonage beside the church, the house that comes with the pulpit, where a pastor performs a faith he lost three years ago for a congregation that does not know. (<em>The Silent Pastor</em>)',
    books: ['the-silent-pastor'],
    seerScene: false,
  },
  {
  ...
  },
  {
    ...
    blurb: 'The weekly market among the stalls by the grain elevator. In <em>The Tending Woman</em>, the Seer finds Elena Voss here in the early light and names the spring she loses the house to keep saying yes, and the apartment above the Crane Street dry cleaner where she ends up.',
    books: ['the-tending-woman'],
    seerScene: true,
  },
  {
    ...
    blurb: 'The reception after Ernesto Torres&rsquo;s funeral, among the casseroles and the parish faces. In <em>The Lawyer Daughter</em>, a calm stranger names, before Diana has even opened the locked drawer, the shape of the choice waiting in it: whichever she makes, she loses the family she spent her life holding together.',
    books: ['the-lawyer-daughter'],
    seerScene: true,
  },
  {
